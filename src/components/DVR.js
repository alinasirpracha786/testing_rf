...
/*const industry = [
{id:1,name: 'Services'},{id:2,name: 'Industry & Manufacturing'},{id:3,name: 'Government'},{id:4,name: 'Military'},{id:5,name: 'Financial Institution'},{id:6,name: 'Chinese-Government Owned Chinese-Pr'},{id:7,name: 'Not-identified'},{id:8,name: 'B2G'},{id:9,name: 'Banking and Finance'},{id:10,name: 'Education'},{id:11,name: 'Manufacturing'},{id:12,name: 'Power Energy and CPEC'},{id:13,name: 'Services and SME'},{id:14,name: 'Advertisement and Publishing'},{id:15,name: 'Apparel and accessories'},{id:16,name: 'Automotive'},{id:17,name: 'Beauty and Cosmetics'},{id:18,name: 'Chemical'},{id:19,name: 'Construction'},{id:20,name: 'Consultancy'},{id:21,name: 'Development'},{id:22,name: 'Electronics'},{id:23,name: 'Embassy and Consulates'},{id:24,name: 'Engineering'},{id:25,name: 'FMCG'},{id:26,name: 'Finance'},{id:27,name: 'Fitness'},{id:28,name: 'Food'},{id:29,name: 'Furniture and Interior Designing'},{id:30,name: 'Health'},{id:31,name: 'International Welfare Org.'},{id:32,name: 'Law and enforcement agencies'},{id:33,name: 'Legal services'},{id:34,name: 'Livestock\/Horti-Agriculture'},{id:35,name: 'Local Welfare Org.'},{id:36,name: 'Media & Entertainment'},{id:37,name: 'Mining'},{id:38,name: 'Oil and Gas'},{id:39,name: 'Others'},{id:40,name: 'Paper and Packaging'},{id:41,name: 'Pharmaceutical'},{id:42,name: 'Power and energy'},{id:43,name: 'Research and development'},{id:44,name: 'Restaurant'},{id:45,name: 'Security'},{id:46,name: 'Sports and athletic apparel'},{id:47,name: 'Technology and IT'},{id:48,name: 'Textile'},{id:49,name: 'Tourism and hospitality'},{id:50,name: 'Trading'},{id:51,name: 'Transportation and logistics'},{id:52,name: 'Wholeseller & Retailer'},{id:53,name: 'Leather'}];
*/
 const products = [
...
console.log(this.state.setproductvalues);
...
console.log(this.state.setindustryvalues);
*/
//console.log("user_id=" +this.state.user.user_id + "&LeadID=" + this.state.user.seller_id+"_"+this.state.numberHolder+ "&sellerID=" + this.state.user.seller_id + "&companyname=" +this.state.company_name + "&POCName=" +this.state.poc_name+ "&POCcontact_no=" +this.state.poc_contactno+ "&PotentialBusiness="+this.state.setproductvalues +"&visitdate="+this.state.visitdate +"&leadstatus="+this.state.leadprogressval+"&latitude=1.72989&longitude=1.72989"+"&leadclosure_status="+this.state.leadclosurestatus+"&officelocation="+this.state.address_info+"&next_visitdate="+this.state.nextDate+"&wayforward="+this.state.way_forward+"&region="+this.state.user.big_region+"&visit_type="+this.state.getvisittypeval+"&industry_type="+this.state.setindustryvalues+"&existing_prod="+this.state.setexisting_prod_values+"&customer_int="+this.state.selectedinterest+"&contract_expiry_date="+this.state.expirydate+"&amount_range="+this.state.selectedrange+"&service_provider="+this.state.selectedoperator+"&cust_not_int="+this.state.selectednotinterest+"&acc_type_val="+this.state.getaccounttypeval);
   ...
   // body: "user_id=" +this.state.user.user_id + "&LeadID=" + this.state.user.seller_id+"_"+this.state.numberHolder+ "&sellerID=" + this.state.user.seller_id + "&companyname=" +this.state.company_name + "&POCName=" +this.state.poc_name+ "&POCcontact_no=" +this.state.poc_contactno+ "&PotentialBusiness="+this.state.setproductvalues +"&visitdate="+this.state.visitdate +"&leadstatus="+this.state.leadprogressval+"&latitude='1.72989'"+this.state.lat_info+"&longitude='1.72989'"+this.state.long_info+"&leadclosure_status="+this.state.leadclosurestatus+"&officelocation="+this.state.address_info+"&next_visitdate="+this.state.nextDate+"&wayforward="+this.state.way_forward+"&region="+this.state.user.big_region+"&visit_type="+this.state.getvisittypeval+"&industry_type="+this.state.setindustryvalues+"&existing_prod="+this.state.setexisting_prod_values+"&customer_int="+this.state.selectedinterest+"&contract_expiry_date="+this.state.expirydate+"&amount_range="+this.state.selectedrange+"&service_provider="+this.state.selectedoperator+"&cust_not_int="+this.state.selectednotinterest+"&acc_type_val="+this.state.getaccounttypeval
...
const ind_arrayToClean = this.state.selectedindustry;
 ...
 //console.log('return product values: ',this.state.setindustryvalues);  
  ...
  getnot_interestedstatus = () => {
    let data = [
      ...
      {
        value: 'Currently customer doesnt have the required budget',
      },
      {
...
<View style={styles.pickerWrapperSearch}>
          <SearchableDropdown
           ...
           selectedItems={this.state.selectedindustry}
            onItemSelect={(item) => {
              console.log(item.id);
              this.setState({ selectedindustryid: item.id });
              const items = this.state.selectedindustry;
              items.push(item)
              this.setState({ selectedindustry: items });
            }}
            containerStyle={{ padding: 5 }}
            onRemoveItem={(item, index) => {
              const items = this.state.selectedindustry.filter((sitem) => sitem.id !== item.id);
              this.setState({ selectedindustry: items });
            }}
            itemStyle={{
              padding: 10,
