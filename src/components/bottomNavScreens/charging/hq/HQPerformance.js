...
import { StyleSheet, View, ScrollView, Text, TouchableOpacity, Alert, ImageBackground, Dimensions, ToastAndroid } from 'react-native';
...
export default class HQPerformance extends React.Component {
  ...
  getAccountsAgainstSeller(myHeaders, seller_username = 0) {
    ...
    return fetch(url, {
      ...
      .then(responseJs => {
        ...
        // //console.warn("\n\nresponse json ACCOUNTS ::::::::::::::::::: ", responseJson, "\n\n");
    ...
    return fetch(url, {
      ...
      .then(responseJs => {
        ...
        if (responseJson.status == 404) {
         ...
         // console.warn("exception thrown", responseJson.app_down_flag);
          if(responseJson.app_down_flag == 1){
        ...
        <ScrollView style={styles.container} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.rowSelectInput}>
            ...
            <View style={styles.smallInputWrapper}>
              ...
              <SearchableDropdown
                onItemSelect={(item) => {
                  //console.warn("selected seller ", item);
                  this.setState({ selectedSellerUsername: item.username });
                  //console.warn("selected seller on state", this.state.selectedSellerUsername);
                  this.getAccountsCharging_prepare();
                }}
                ...
                items={this.state.sellersSourceList}
                // defaultIndex={2}
                resetValue={false}
                textInputProps={
                  {
