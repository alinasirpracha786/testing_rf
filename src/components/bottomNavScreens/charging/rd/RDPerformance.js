            ...
            <View style={styles.smallInputWrapper}>
              ...
              <SearchableDropdown
                onItemSelect={(item) => {
                  ...
                  this.setState({ selectedAccountName: item.name.toLowerCase() });
                  //console.log("--------- >>>>>>>> selected account on state", this.state.selectedAccountName);
                ...
                textInputProps={
                  {
                    ...
                    onTextChange: text => { this.setState({ selectedAccountName: text.toLowerCase() }); }
                  }
                }
                listProps={
                  {
