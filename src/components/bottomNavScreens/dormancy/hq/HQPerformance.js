...
export default class HQPerformance extends React.Component {
  ...
  constructor(props) {
    ...
    //console.warn("inside HQPerformance", this.props.navigation.getParam('user', null));
    ...
    return (
      ...
      <ImageBackground source={{ uri: this.state.user.punch }} style={{ width: "100%", height: "100%" }} imageStyle={{ height: "200%", width: "100%", resizeMode: "repeat" }}>
        ...
        <ScrollView style={styles.container}>
          ...
          <View>
            <Text style={styles.title}>NWD Dormancy{"\n"}{this.state.title}</Text>
          </View>
