...
export default class DVRRDPerformance extends Component {
  state = {
...
getRevenueBigStreamPerformance_open(myHeaders,title) {
  ...
  const url =
    apiHost +
    '/soa_dvr/get_mtd_subscriber_base_product_wise_dvr/rd/' +
  ...
  getRevenueBigStreamPerformance(myHeaders) {
    ...
    const url =
      apiHost +
      '/soa_dvr/get_mtd_all_kpi_big_stream_dvr/rd/' +
  ...
  getRDPerformance(value, myHeaders) {
    ...
    const url = apiHost + '/soa_dvr/get_mtd_all_kpi_dvr/rd' + '/' + value;
    //console.warn('url', url);
    return fetch(url, {
      method: 'GET',
      headers: myHeaders
...
//console.warn("seller wise info"+title+""+vstatus);
  ...
  getAccountWiseDiscount_compnwise(title, myHeaders,vstatus) {
   ...
   // let is_positive = (this.state.productsDeltaValArray[title].indexOf("-") >= 0) ? 0 : 1;
    ...
    const url =
      apiHost +
      '/soa_dvr/get_mtd_discount_account_wise_dvr_sellerwise/rd/' +
      this.state.selectedRDValue +'/'+
  ...
  getAccountWiseDiscount(title, myHeaders,visitstatus) {
    ...
    const url =
      apiHost +
      '/soa_dvr/get_mtd_discount_account_wise_dvr/rd/' +
