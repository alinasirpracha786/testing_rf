...
class leadoptions extends Component {
  ...
  getexisitngleads = () =>{
   ...
   //this.findemployee();
        ...
        /*  lat_info:this.state.latitude,
          long_info:this.state.longitude,
          address_info:this.state.locationname ,*/
         ...
         <View
          style={{ flexDirection: 'column', justifyContent: 'flex-start' }}>
            ...
            <Button
              ...
              alignItems='center'
              onPress={() => {
                console.warn("REDIRECT CODE latitude ::",this.state.user.employee_no);
