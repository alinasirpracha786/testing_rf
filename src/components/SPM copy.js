...
class SPM extends Component {
  ...
  sendFeedbackToSPM = () => {
    ...
    console.log('here is the user_id: ', this.state.industry_type);
    console.log("lead_name=" +this.state.compname + "&employee_id=" + this.state.employee_no+ "&potential_closing_date=" + this.state.visitdate+ "&servicing_manager=0000" +"&customer_type=1"+"&segment="+this.state.selectedsegment+"&industry="+this.state.selectedindustry+"&p_mrc=1000&p_otc=500&win_probability=80&created_by=9876&gross_adds=1203&potential_charging_date=000&" + "&company_ntn=" +this.state.company_ntn + "&company_poc_name=" +this.state.poc_name+ "&company_poc_number=" +this.state.poc_no+ "&project_remarks="+this.state.remarks +"&existing_zong_services[0]='zong'&product_leads[0]='VPBX'&existing_zong_services[1]=1&product_leads[1]=2");
   ...
   body: "lead_name=" +this.state.compname + "&employee_id=" + this.state.employee_no+ "&potential_closing_date=" + this.state.visitdate+ "&servicing_manager=0000" +"&customer_type=1"+"&segment="+this.state.selectedsegment+"&industry="+this.state.selectedindustry+"&p_mrc=1000&p_otc=500&win_probability=80&created_by=9876&gross_adds=1203&potential_charging_date=000&" + "&company_ntn=" +this.state.company_ntn + "&company_poc_name=" +this.state.poc_name+ "&company_poc_number=" +this.state.poc_no+ "&project_remarks="+this.state.remarks +"&existing_zong_services[0]='zong'&product_leads[0]='VPBX'&existing_zong_services[1]=1&product_leads[1]=2"
      ...
      <View
          ...
          <View style={styles.pickerWrapper}>
            <Dropdown
              ...
              textInputProps={
                {
                  placeholder: this.state.selectedindustry,
          ...
          {this.state.selectedindustry === 'Select Industry Type' || this.state.selectedsegment === 'Select Segment Type' ? null : 
