...
export default class DVRTLPerformance extends Component {
  ...
  getTLPerformance(value, myHeaders) {
    ...
    const url = apiHost + '/soa_dvr/get_mtd_all_kpi_dvr/teamlead' + '/' + value;
    //console.log('url', url);
    return fetch(url, {
      method: 'GET',
      headers: myHeaders
...
getRevenueBigStreamPerformance_open(myHeaders,title) {
  ...
  const url =
    apiHost +
    '/soa_dvr/get_mtd_subscriber_base_product_wise_dvr/teamlead/' +
  ...
  getRevenueBigStreamPerformance(myHeaders) {
    ...
    const url =
      apiHost +
      '/soa_dvr/get_mtd_all_kpi_big_stream_dvr/teamlead/' +
      this.state.selectedTLValue;
    //console.warn(url);
    return fetch(url, {
      method: 'GET',
...
getRevenueBigStreamPerformance_open(myHeaders,title) {
  ...
  getAccountWiseDiscount(title, myHeaders,visitstatus) {
   ...
   // let is_positive = (this.state.productsDeltaValArray[title].indexOf("-") >= 0) ? 0 : 1;
    ...
    const url =
      apiHost +
      '/soa_dvr/get_mtd_discount_account_wise_dvr/teamlead/' +
      this.state.selectedTLValue +
...
//console.warn("seller wise info"+title+""+vstatus);
  ...
  getAccountWiseDiscount_compnwise(title, myHeaders,vstatus) {
   ...
   // let is_positive = (this.state.productsDeltaValArray[title].indexOf("-") >= 0) ? 0 : 1;
    ...
    const url =
      apiHost +
      '/soa_dvr/get_mtd_discount_account_wise_dvr_sellerwise/teamlead/' +
      this.state.selectedTLValue +'/'+
