...
export default class TLPerformanceMOM extends Component {
  ...
  getTLPerformance( myHeaders) {
    ...
    const url = apiHost + '/soa/get_mom_seller_performance/teamlead' + '/' + this.state.user.username+"/"+this.state.selectedYearValue;
    console.log('url', url);
    return fetch(url, {
      method: 'GET',
      headers: myHeaders
  ...
  getAccountWisePerformanceForProduct(title, myHeaders) {
    ...
    return fetch(url, {
      ...
      .then(responseJs => {
        ...
        //console.log("NO ERROR ::::::::::::::::::::::::: ", responseJson);
    ...
    return (
      ...
      <ImageBackground source={{ uri: this.state.user.punch }} style={{ width: "100%", height: "100%" }} imageStyle={{ height: "200%", width: "100%", resizeMode: "repeat" }}>
        ...
        <ScrollView style={styles.container}>
          ...
          <View>
            <Text style={styles.title}>{this.state.user.name}'s Team{"\n"}{this.state.subTitle}</Text>
          </View>
