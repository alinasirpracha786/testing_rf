...
export default class RDPerformance extends Component {
  ...
  getRevenueBigStreamPerformance(myHeaders) {
    ...
    const url =
      apiHost +
      '/soa/get_mtd_all_kpi_big_stream/rd/' +
  ...
  getRDPerformance(value, myHeaders) {
    ...
    const url = apiHost + '/soa/get_mtd_all_kpi/rd' + '/' + value;
    //console.log('url', url);
    return fetch(url, {
      method: 'GET',
      headers: myHeaders
  ...
  getProductWiseDiscount(title, myHeaders) {
    ...
    const url =
      apiHost +
      '/soa/get_mtd_discount_product_wise/rd/' +
      this.state.selectedRDValue +
      '/0/0/';
    //console.warn(url);
    return fetch(url, {
  ...
  getProductWisePayment(title, myHeaders) {
    ...
    const url =
      apiHost +
      '/soa/get_mtd_payment_product_wise/rd/' +
      this.state.selectedRDValue +
      '/0/0/';
    //console.warn(url);
    return fetch(url, {
  ...
  getProductWiseBase(title, myHeaders) {
    ...
    const url =
      apiHost +
      '/soa/get_mtd_subscriber_base_product_wise/rd/' +
      this.state.selectedRDValue +
      '/0/0/';
    //console.warn(url);
    return fetch(url, {
  ...
  getAccountWiseDiscount(title, myHeaders) {
    ...
    const url =
      apiHost +
      '/soa/get_mtd_discount_account_wise/rd/' +
      this.state.selectedRDValue +
      '/0/0/' + title.trim() + '/' + is_positive;
    console.warn(url);
    return fetch(url, {
  ...
  getAccountWisePayment(title, myHeaders) {
    ...
    const url =
      apiHost +
      '/soa/get_mtd_payment_account_wise/rd/' +
      this.state.selectedRDValue +
      '/0/0/' + title.trim() + '/' + is_positive;
    //console.warn(url);
    return fetch(url, {
  ...
  getAccountWiseBase(title, myHeaders) {
    ...
    const url =
      apiHost +
      '/soa/get_mtd_subscriber_base_account_wise/rd/' +
      this.state.selectedRDValue +
      '/0/0/' + title.trim() + '/' + is_positive;
    //console.warn(url);
    return fetch(url, {
  ...
  getProductWiseGCR(indicator, myHeaders) {
    ...
    const url =
      apiHost +
      '/soa/get_mtd_gcr_product_wise/rd/' +
      this.state.selectedRDValue +
      '/0/0/' +
      indicator;
    //console.warn(url);
  ...
  getAccountWiseGCR(product, indicator, myHeaders) {
    ...
    const url =
      apiHost +
      '/soa/get_mtd_gcr_account_wise/rd/' +
      this.state.selectedRDValue +
      '/0/0/' +
      indicator +
      '/' +
    ...
    return fetch(url, {
      ...
      .then(responseJs => {
        ...
        if (responseJson.status == 401) {
          ...
          //console.warn('updated state.tableData: ', this.state.responseJson);
