...
export default class DVRRSMPerformance extends Component {
  ...
  getRSMPerformance(value, myHeaders) {
    ...
    const url = apiHost + '/soa_dvr/get_mtd_all_kpi_dvr/rsm' + '/' + value;
    console.log('url', url);
    return fetch(url, {
      method: 'GET',
      headers: myHeaders
  ...
  getRevenueBigStreamPerformance(myHeaders) {
    ...
    const url =
      apiHost +
      '/soa_dvr/get_mtd_all_kpi_big_stream_dvr/rsm/' +
      this.state.selectedRSMValue;
    ////console.warn(url);
    return fetch(url, {
      method: 'GET',
...
//console.warn("seller wise info"+title+""+vstatus);
  ...
  getAccountWiseDiscount_compnwise(title, myHeaders,vstatus) {
   ...
   // let is_positive = (this.state.productsDeltaValArray[title].indexOf("-") >= 0) ? 0 : 1;
    ...
    const url =
      apiHost +
      '/soa_dvr/get_mtd_discount_account_wise_dvr_sellerwise/rsm/' +
      this.state.selectedRSMValue +'/'+
  ...
  getAccountWiseDiscount(title, myHeaders,visitstatus) {
   ...
   // let is_positive = (this.state.productsDeltaValArray[title].indexOf("-") >= 0) ? 0 : 1;
    ...
    const url =
      apiHost +
      '/soa_dvr/get_mtd_discount_account_wise_dvr/rsm/' +
      this.state.selectedRSMValue +
...
getRevenueBigStreamPerformance_open(myHeaders,title) {
  ...
  const url =
    apiHost +
    '/soa_dvr/get_mtd_subscriber_base_product_wise_dvr/rsm/' +
