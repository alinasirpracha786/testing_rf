...
class leadopen extends Component { 
                  ...
                  onPress: () => {
                    ...
                    if (this.state.leadclosurestatus != 'Open') {
                      ...
                      this.props.navigation.navigate('SPM',{
                        ...
                        poc_no:this.state.pocno,
                        poc_name:this.state.pocname,
                        compname:this.state.selectedCompany,
                        industry_type:this.state.industry_id,
                        product_type:this.state.potentialbusiness,                      
                        remarks: this.state.updatedcomments,        
                     });
   ...
   this.setState({companyselected:compval});
    ...
    return fetch('https://gcssbi.zong.com.pk/index.php/summary/getcompwisedata?CompanyName='+compval, {
      ...
      .then(myData => {
       ...
       const industryid=res.industry_type[i].split("-");
        let industryidval = industryid[0];
        let industrycategory = industryid[1];
        console.log('kkf',industryid[0]);
         let obj = {
           userid: res.userid[i],
           leadid: res.leadid[i],
         ...
         this.setState({industry_id:industryidval}),
         this.setState({industry_type:industrycategory}),
