...
import DashboardRSMDVR from '../bottomNavDashboards/DVR/DashboardRSMDVR';
import DashboardRSMMTD from '../bottomNavDashboards/mtd/DashboardRSMMTD';
import DashboardRSMDORMANCY from '../bottomNavDashboards/dormancy/DashboardRSMDORMANCY';
import DashboardRSMCHARGING from '../bottomNavDashboards/charging/DashboardRSMCHARGING';
import DashboardRSMGEN_FEEDBACK from '../bottomNavDashboards/gen_feedback/DashboardRSMGEN_FEEDBACK';

import DashboardRSMMOM_PERFORMANCE from '../bottomNavDashboards/mom_performance/DashboardRSMMOM';
...
const DashboardRSMMTD_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  RSMMTD: {
    screen: DashboardRSMMTD,
...
const DashboardRSMDVR_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  RSMDVR: {
    screen: DashboardRSMDVR,
    navigationOptions: ({ navigation }) => ({
...
const DashboardRSMDORMANCY_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  RSMMTD: {
    screen: DashboardRSMDORMANCY,
    navigationOptions: ({ navigation }) => ({
...
const DashboardRSMCHARGING_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  RSMCHARGING: {
    screen: DashboardRSMCHARGING,
    navigationOptions: ({ navigation }) => ({
...
const DashboardRSMGEN_FEEDBACK_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  RSMGEN_FEEDBACK: {
    screen: DashboardRSMGEN_FEEDBACK,
    navigationOptions: ({ navigation }) => ({
...
const DashboardRSMMOM_PERFORMANCE_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  RSMMOM_PERFORMANCE: {
    screen: DashboardRSMMOM_PERFORMANCE,
    navigationOptions: ({ navigation }) => ({
...
const DrawerRSM = createDrawerNavigator(
  {

    DashboardRSMMTD: { //Title
      screen: DashboardRSMMTD_StackNavigator,
      navigationOptions: ({ navigation }) => ({
    ...
    DashboardRSMDVR: { //Title
      screen: DashboardRSMDVR_StackNavigator,
      navigationOptions: ({ navigation }) => ({
    ...
    DashboardRSMDORMANCY: { //Title
      screen: DashboardRSMDORMANCY_StackNavigator,
      navigationOptions: ({ navigation }) => ({
    ...
    DashboardRSMCHARGING: { //Title
      screen: DashboardRSMCHARGING_StackNavigator,
      navigationOptions: ({ navigation }) => ({
    ...
    DashboardRSMGEN_FEEDBACK: { //Title
      screen: DashboardRSMGEN_FEEDBACK_StackNavigator,
      navigationOptions: ({ navigation }) => ({
    ...
    DashboardRSMMOM_PERFORMANCE: { //Title
      screen: DashboardRSMMOM_PERFORMANCE_StackNavigator,
      navigationOptions: ({ navigation }) => ({
  ...
  {
    intialRouteName: 'DashboardRSMGEN_FEEDBACK',
    navigationOptions: {
      headerStyle: {
...
export default createAppContainer(DrawerRSM);
