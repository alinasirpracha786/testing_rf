...
import DashboardTLDVR from '../bottomNavDashboards/DVR/DashboardTLDVR';
import DashboardTLMTD from '../bottomNavDashboards/mtd/DashboardTLMTD';
import DashboardTLDORMANCY from '../bottomNavDashboards/dormancy/DashboardTLDORMANCY';
import DashboardTLCHARGING from '../bottomNavDashboards/charging/DashboardTLCHARGING';
import DashboardTLGEN_FEEDBACK from '../bottomNavDashboards/gen_feedback/DashboardTLGEN_FEEDBACK';
import DashboardTLMOM_PERFORMANCE from '../bottomNavDashboards/mom_performance/DashboardTLMOM';
...
const DashboardTLMTD_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  TLMTD: {
    screen: DashboardTLMTD,
...
const DashboardTLDVR_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  TLDVR: {
    screen: DashboardTLDVR,
    navigationOptions: ({ navigation }) => ({
...
const DashboardTLDORMANCY_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  HQMTD: {
    screen: DashboardTLDORMANCY,
    navigationOptions: ({ navigation }) => ({
...
const DashboardTLCHARGING_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  TLCHARGING: {
    screen: DashboardTLCHARGING,
    navigationOptions: ({ navigation }) => ({
...
const DashboardTLGEN_FEEDBACK_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  TLGEN_FEEDBACK: {
    screen: DashboardTLGEN_FEEDBACK,
    navigationOptions: ({ navigation }) => ({
...
const DashboardTLMOM_PERFORMANCE_StackNavigator = createStackNavigator({
  //All the screen from the Screen1 will be indexed here
  TLMOM_PERFORMANCE: {
    screen: DashboardTLMOM_PERFORMANCE,
    navigationOptions: ({ navigation }) => ({
...
const DrawerTL = createDrawerNavigator(
  {

    DashboardTLMTD: { //Title
      screen: DashboardTLMTD_StackNavigator,
      navigationOptions: ({ navigation }) => ({
    ...
    DashboardTLDVR: { //Title
      screen: DashboardTLDVR_StackNavigator,
      navigationOptions: ({ navigation }) => ({
        drawerLabel: "Monthly DVR Summary",
        drawerIcon: ({ tintColor }) => <Icon name="calendar-day" size={25} style={[{ color: tintColor }]} />,
      }),
    },
    ...
    DashboardTLDORMANCY: { //Title
      screen: DashboardTLDORMANCY_StackNavigator,
      navigationOptions: ({ navigation }) => ({
    ...
    DashboardTLCHARGING: { //Title
      screen: DashboardTLCHARGING_StackNavigator,
      navigationOptions: ({ navigation }) => ({
    ...
    DashboardTLGEN_FEEDBACK: { //Title
      screen: DashboardTLGEN_FEEDBACK_StackNavigator,
      navigationOptions: ({ navigation }) => ({
    ...
    DashboardTLMOM_PERFORMANCE: { //Title
      screen: DashboardTLMOM_PERFORMANCE_StackNavigator,
      navigationOptions: ({ navigation }) => ({
  ...
  {
    intialRouteName: 'DashboardTLGEN_FEEDBACK',
    navigationOptions: {
      headerStyle: {
...
export default createAppContainer(DrawerTL);
